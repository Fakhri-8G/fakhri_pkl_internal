...
<head>
    ...
    <style>
        .sidebar {
            min-height: 100vh;
            background: linear-gradient(180deg, #312885 0%, #0f172a 100%);
        }
        .sidebar .nav-link {
...
<body class="bg-light">
    <div class="d-flex">
        ...
        <div class="flex-grow-1">
            {{-- Top Bar --}}
            <header class="navbar shadow-sm py-3 px-4 d-flex justify-content-between align-items-center">
                <h4 class="mb-0 text-white">@yield('page-title', 'Dashboard')</h4>
                <div class="d-flex align-items-center">
                    <a href="{{ route('home') }}" class="btn btn-outline-secondary btn-sm me-2 text-white" target="_blank">
